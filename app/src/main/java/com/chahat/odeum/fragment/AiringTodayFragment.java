...
public class AiringTodayFragment extends Fragment implements SharedItemClickListner,LoadPagesInterface,SwipeRefreshLayout.OnRefreshListener{

    @BindView(R.id.refresh) SwipeRefreshLayout refreshLayout;
    @BindView(R.id.recyclerView) RecyclerView recyclerView;
    private TvShowAdapter tvShowAdapter;
    private Parcelable mRecyclerState;
    public static final String  TAG = "AiringTodayFragment";
    ...
    private void getAiringTodayShow(final int page){
        refreshLayout.setRefreshing(true);
        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<TvShowResponse> call = apiInterface.getAiringTodayShow(API_KEY,page);
